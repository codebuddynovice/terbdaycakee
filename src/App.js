...
export default function App() {
  ...
  <div className="App">
     ...
     <img src={birthdayText} alt="Happy Birthday" 
  className="birthdayText" draggable={false} />
      ...
      {celebrating && (
        <Confetti
          ...
          onDone={() => {
            ...
            setTimeout(() => setShowTer(true), 250);
          }}
        />
      )}
      ...
      {showTer && (
        <div
          ...
          onClick={() => setShowTer(false)}
          onKeyDown={(e) => {
            if (e.key === "Escape") setShowTer(false);
          }}
          role="dialog"
          tabIndex={-1}
        >
          <div className="ter-card">
            {terSrc ? (
              <img src={terSrc} alt="Ter" />
            ) : (
              <div style={{ color: "white", padding: 24, fontSize: 20 }}>
                Wishing you a day filled with warmth, laughter, and the kind of joy that lingers long after the candles are blown out. 
                May this year bring you closer to the dreams you hold dear, surround you with people who lift you up, and offer moments that make your heart smile. 
                You deserve all the good things life has to offer—today and always
              </div>
            )}
          </div>
        </div>
